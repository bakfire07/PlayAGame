...
def run_vary_theta_nodes_centrality():
    ...
    for num_nodes in num_nodes_list:
        ...
        for theta in theta_list:
            ...
            print 'Num of nodes:%d , Theta:%f with strategy:%s '%(num_nodes,theta,str(result.items()))
            print 'Num of nodes:%d , Theta:%f  random strategy:%s '%(num_nodes,theta,str(result1.items()))
